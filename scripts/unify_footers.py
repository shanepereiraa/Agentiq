    ...
    <div class="max-w-6xl mx-auto">
      <div class="grid grid-cols-2 md:grid-cols-5 gap-10 mb-12">
        ...
        <div class="col-span-2 md:col-span-1">
          <a href="/" class="flex items-center gap-2.5 mb-4" aria-label="AgentIQ home">
            <span class="font-display font-700 text-lg text-white tracking-tight inline-flex items-baseline gap-0.5">Agent<span class="logo-grad-text">IQ</span><svg class="w-2.5 h-2.5 shrink-0" viewBox="0 0 16 14" fill="none" aria-hidden="true" focusable="false"><defs><linearGradient id="iq-wave-ftr-uni" x1="0" y1="14" x2="16" y2="0"><stop offset="0" stop-color="#FF8A5B"/><stop offset="0.5" stop-color="#FF5C8A"/><stop offset="1" stop-color="#C74AFF"/></linearGradient></defs><rect x="0" y="9" width="3" height="5" rx="1.2" fill="url(#iq-wave-ftr-uni)"/><rect x="4.5" y="6" width="3" height="8" rx="1.2" fill="url(#iq-wave-ftr-uni)"/><rect x="9" y="3" width="3" height="11" rx="1.2" fill="url(#iq-wave-ftr-uni)"/><rect x="13" y="0" width="3" height="14" rx="1.2" fill="url(#iq-wave-ftr-uni)"/></svg></span>
          </a>
        ...
        <!-- Company & Trust -->
        <div>
          <p class="text-white font-600 text-sm mb-4">Company &amp; Trust</p>
          <ul class="space-y-2.5 text-sm text-slate-400">
            <li><a href="/#pricing" class="hover:text-white transition-colors">Pricing</a></li>
            <li><a href="/#results" class="hover:text-white transition-colors">Results</a></li>
            <li><a href="/#faq" class="hover:text-white transition-colors">FAQ</a></li>
            <li><a href="/blog" class="hover:text-white transition-colors">Blog</a></li>
            <li><a href="/privacy-security" class="hover:text-white transition-colors">Security &amp; Privacy Center</a></li>
            <li><a href="/privacy.html" class="hover:text-white transition-colors">Privacy Policy</a></li>
            <li><a href="/terms.html" class="hover:text-white transition-colors">Terms of Service</a></li>
            <li><a href="/privacy-security#vdp" class="hover:text-white transition-colors">VDP (Security)</a></li>
        ...
        <!-- Free Tools -->
        <div>
          <p class="text-white font-600 text-sm mb-4">Free Tools</p>
          <ul class="space-y-2.5 text-sm text-slate-400">
            <li><a href="/tools/staff-vs-ai-calculator.html" class="inline-flex items-center gap-1.5 hover:text-white transition-colors">Staff vs AI Calculator <span class="text-[10px] font-700 px-1.5 py-0.5 rounded bg-cyan/20 text-cyan border border-cyan/30 uppercase tracking-wider">Free Tool</span></a></li>
            <li><a href="/tools/whatsapp-link-generator.html" class="hover:text-white transition-colors">WhatsApp Link Generator</a></li>
            <li><a href="/try-your-bot" class="hover:text-white transition-colors">Interactive Bot Playground</a></li>
          </ul>
        </div>
        <!-- Contact -->
        <div>
      ...
      <div class="pt-8 border-t border-white/8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-400">
        ...
        <div class="flex flex-wrap items-center justify-center gap-3 text-xs text-slate-400">
          ...
          <span>·</span>
          <a href="/privacy-security#cookies" class="hover:text-white transition-colors">Cookie Policy</a>
          <span>·</span>
          <a href="/privacy-security#vdp" class="hover:text-white transition-colors">VDP</a>
        </div>
      </div>
    </div>
  </footer>'''
...
def update_file(file_path):
    ...
    # Match from <footer ... </footer> (dot matches newline)
    pattern = r'<footer[\s\S]*?</footer>'
    if not re.search(pattern, content):
        print(f"Skipped (no footer found): {file_path}")
        return False

    new_content = re.sub(pattern, UNIFIED_FOOTER.strip(), content)
